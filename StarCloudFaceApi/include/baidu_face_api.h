...
public:
 ...
 // 人脸对比(特征值和图片比对)
    ...
    */
    ...
    const char* rgb_ir_liveness_check(std::vector<TrackFaceInfo>*&out, const cv::Mat& rgb_mat, const cv::Mat&ir_mat,
    ...
    const char* rgb_depth_liveness_check(std::vector<TrackFaceInfo>*&out, const cv::Mat& rgb_mat, const cv::Mat&depth_mat,
